...
const CACHE_NAME = 'logistica-quiz-cache-v21';
const urlsToCache = [
  './',
  './index.html',
  './index.js',
  ...
  'https://i.postimg.cc/K8D7v2fg/Questify_Logo_Web.png',
  'https://i.postimg.cc/x13GT25N/Questifylogo.png',
  'https://i.postimg.cc/Vk8B86qF/Questify_App_Icon.png',
